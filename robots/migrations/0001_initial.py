...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='rule',
            name='disallowed',
            field=models.ManyToManyField(to='robots.Url', verbose_name='disallowed', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='rule',
            name='allowed',
            field=models.ManyToManyField(to='robots.Url', verbose_name='allowed', blank=True),
            preserve_default=True,
        ),
    ]
